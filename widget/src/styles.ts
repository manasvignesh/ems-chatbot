...
.ems-suggestions::-webkit-scrollbar {
  display: none;
}
...
.ems-error-overlay {
  ...
  overflow: hidden;
  pointer-events: auto;
  animation: ems-fade-in 0.3s ease-out;
}
...
.ems-error-window {
  ...
  overflow: hidden;
  animation: ems-pop-in 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);
}
